...
$destination_path = $destination_directory . $picnew;
...
$destination_directory = "idproofimages/";
$destination_path = $destination_directory . $idproof;

if (!file_exists($destination_directory)) {
    mkdir($destination_directory, 0777, true); // Create the directory if it doesn't exist
}

if (move_uploaded_file($_FILES["idproof"]["tmp_name"], $destination_path)) {
    echo "File moved successfully to: " . $destination_path;
} else {
    echo "Error moving file to destination";
}
