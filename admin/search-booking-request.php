              ...
              <?php include_once('includes/header.php');?>
               ...
               <form id="basic-form" method="post">
                                <div class="form-group">
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Enter Job ID or Name"></div>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
                                    <table class="table table-bordered">
                                       ...
                                       <tbody>
                                          <?php
$sql= "SELECT * from tblmaidbooking where tblmaidbooking.JobID like '$sdata%' || tblmaidbooking.Name like '$sdata%'";
...
<?php } ?> 
                                         <td class="d-none d-sm-table-cell"><a href="view-booking-detail.php?editid=<?php echo htmlentities ($row->ID);?>&&bookingid=<?php echo htmlentities ($row->JobID);?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                    </tr>
                                          <?php 
$cnt=$cnt+1;
} } else { ?>
