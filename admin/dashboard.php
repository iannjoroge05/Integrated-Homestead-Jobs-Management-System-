                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="full counter_section margin_bottom_30">
                              ...
                              <div class="counter_no">
                                 <div>
                                    <?php 
                        $sql4 ="SELECT * from  tblmaidapplications ";
$query4 = $dbh -> prepare($sql4);
$query4->execute();
$results4=$query4->fetchAll(PDO::FETCH_OBJ);
$totreq=$query4->rowCount();
?>
                                   <p class="total_no"><?php echo htmlentities($totreq);?></p>
                                    <p class="head_couter">Maid Applications<br /><br />
                                       <a href="admin_maid_applications.php" class="btn btn-primary btn-sm">View Details</a></p>
                                 </div>
